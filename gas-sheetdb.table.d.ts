...
declare class _GasSheetDbTable {
    ...
    constructor({ spreadsheet, sheetName, rowNumbers, }: GasSheetDbTableConstructorOptions);
    /**
     ...
     */
    findWhere(predicateFn: (entry: GasSheetDbEntry) => boolean): GasSheetDbEntry[] | null;
    /**
     * Find the first matching entry.
     */
    findOneWhere(predicateFn: (entry: GasSheetDbEntry) => boolean): GasSheetDbEntry | null;
    /**
     * Find trashed entries.
     * Optionally, filter trashed entries.
     */
    findTrashed(predicateFn?: ((entry: GasSheetDbEntry) => boolean) | null): GasSheetDbEntry[];
    /**
